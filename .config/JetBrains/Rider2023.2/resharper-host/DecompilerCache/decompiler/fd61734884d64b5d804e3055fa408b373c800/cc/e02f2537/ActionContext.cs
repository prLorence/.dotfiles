...
namespace Microsoft.AspNetCore.Mvc
{
  ...
  public class ActionContext
  {
    ...
    /// </remarks>
    public ActionContext() => this.ModelState = new ModelStateDictionary();
    ...
    public ActionContext(ActionContext actionContext)
      : this(actionContext.HttpContext, actionContext.RouteData, actionContext.ActionDescriptor, actionContext.ModelState)
    {
    }
